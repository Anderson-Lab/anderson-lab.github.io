...
I will be designing these labs to be automatically graded. There will be a discussion thread for each week
on Canvas. Students are encouraged to post anything other than direct solutions (and of course appropriate material).
...
Below is our tentative schedule. It is subject to change, but any changes will be reflected here. First, I want to say a few words about
my world. Monday is honestly my best day for generating new material, lectures, meetings, etc.
...
**How did we pick the order?** I have endeavored to pick an order that will allow us to approach the data analysis
