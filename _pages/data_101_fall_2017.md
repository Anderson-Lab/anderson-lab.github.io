...
After the competition is over, we will revert to a more standard lecture+lab course setup. Targeted data science lessons on concepts discussed in class. The topics will vary from week to week. They are designed to build up your skills to accomplish the next two tasks. Predicting the survival rate on the titanic (https://www.kaggle.com/c/titanic-gettingStarted). As we progress towards the end of the semester, there will be a number of assignments focused on this prediction task.
