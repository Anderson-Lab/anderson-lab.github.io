...
# Table of contents
1. [Syllabus](/csc_448_2022_fall/)
2. [Schedule](/csc_448_2022_fall/schedule/)
...
## Student hours:
OK. These are called Office Hours by the university, but that's a bad name for them.
I have many "offices" on campus and even consider many coffee shops my office. The
...
I provide extensive notes organized into topics. These topics are motivated by this textbook: <a href="https://www.bioinformaticsalgorithms.org/">Bioinformatics Algorithms</a>. The authors provide some of the chapters free of charge. While we go further or in a different directions than the textbook for our projects, tutorials, and other hands on activities, the textbook grounds this course and provides structure. I do not strictly require the textbook. I leave that decision up to you. I will say that the textbook will greatly enhance your learning, and I would recommend it.
...
## Grading
I keep one set of records and grades displayed on Canvas. You are responsible for making sure that this is correctly reflected in Canvas. Canvas is our official record of grades.
...
* A lot of my own thinking is driven by my own experiences. The education system almost completely missed for me. I did not focus or engage with school until fortune intervened on my behalf. I moved from Maryland to Ohio in my junior year of HS. It was only because of a conversation while onboarding at that new school. They asked me to select my own classes for the first time in my life. I had the power because I was a transfer student. I thought what the hell, I'll jump into all these honors and AP classes. And they were hard. But C's in hard classes became B's in hard classes became A's in college. I don't put a lot of weight on
inherent ability and instead direct my focus on three things:
  1. We do the best we can with what we know, and when we know better, we do better. - Maya Angelou
  2. I will eventually understand something given enough time and effort.
  3. Choose the path that is hard. Spend time on what interests you.
...
* A typical Topic will be worth 3 participation points. Documentation to be uploaded to Canvas. You will get 3/3 for good participation, etc.
